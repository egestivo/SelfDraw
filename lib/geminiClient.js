...
1.  **FASE 0: CONVERSACIÓN INICIAL (4-6 Intercambios)**
    ...
    - MANTÉN esta fase entre 4 y 6 intercambios. No te apresures, pero tampoco te extiendas demasiado.
...
3.  **FASE 2: REFLEXIÓN POST-DIBUJO (3-6 Intercambios)**
    ...
    - **LUEGO:** SIEMPRE debes aplicar un test para efectos de evaluación del prototipo. Sigue esta lógica estricta:
        ...
        - **EN CUALQUIER OTRO CASE** (Ansiedad, Alegría, Enojo, Calma, etc.): Usa [ACCION: MOSTRAR_TEST] [TEST: gad-7]
...
async function getChatResponse(history, message) {
    try {
        ...
        const reinforcedMessage = message + systemContext;
